...
# Run your command
python testBabyaiEnv.py --env custom-dynamic --obs fully-observable --num-conv-layers 3 --num_env=32 --num-timesteps 3000000 --size 6 --reward-shaping True
...
python testBabyaiEnv.py --env custom-dynamic --obs fully-observable --num-conv-layers 8 --num_env=32 --num-timesteps 3000000 --size 6 --reward-shaping True
